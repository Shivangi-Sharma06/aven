...
/**
 * GET /api/work-sessions/[sessionId]/changes
 *
 * Returns a GithubCompare object for the work session's commit range.
 * Caller must be the stream sender or recipient.
 * Returns 404 with a structured reason if no repository or commits exist.
